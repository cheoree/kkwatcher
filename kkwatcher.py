...
def check(name, deptId, prdSalStcd, period, bgnDate, endDate, prdCtgIds) :
    ...
    while True:
        ...
        response = session.post("https://reservation.knps.or.kr/reservation/campsite/campsites.do", data=data, headers=headers)
        ...
        elif is_snooze and time.time() - snooze_start >= 300:
